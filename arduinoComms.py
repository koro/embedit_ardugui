...
def valReqToArduinoShanghai(): # freq, phase, amp, freq, phase, amp
 	sendStr = "0"
	print "SENDSTR %s" %( sendStr)
	sendToArduino(sendStr)
        # recvFromArduino(0.01)

def valToArduinoShanghai(f1, p1, a1, f2, p2, a2): # freq, phase, amp, freq, phase, amp
 	sendStr = "1,%s,%s,%s,%s,%s,%s" %(f1, p1, a1, f2, p2, a2)
	print "SENDSTR %s" %( sendStr)
	sendToArduino(sendStr)
        # recvFromArduino(0.01)
